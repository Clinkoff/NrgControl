  ...
  const slides = [
    {
      ...
      articleUrl: "#energia-solar"
    },
    {
      id: 2,
      image: "assets/imagem2.png", 
      title: "Diminua Seus Gastos",
      description: "Estratégias inteligentes para reduzir custos e manter a rotina",
      articleUrl: "#diminuir-gastos"
    },
    {
      id: 3,
      ...
      articleUrl: "#como-economizar"
    },
    {
      id: 4,
      image: "assets/imagem4.png",
      title: "Consumo Inteligente",
      description: "Forme de transformar seu lar em um ambiente de consumo inteligente",
      articleUrl: "#consumo-inteligente"
    }
  ];
        ...
        >
          {slides.map((slide, index) => (
            ...
            >
              ...
              {/* Conteúdo do slide */}
              <div className={`relative z-10 text-center text-white px-8 md:px-16 space-y-6 max-w-4xl transition-all duration-700 absolute bottom-16 left-1/2 transform -translate-x-1/2 ${
                ...
                {/* Ver Mais button */}
                <button 
                  onClick={() => handleVerMais(slide.articleUrl)}
                  className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold px-8 py-3 rounded-2xl shadow-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl border border-white/20"
                >
                  Ver Mais
                </button>
              </div>
