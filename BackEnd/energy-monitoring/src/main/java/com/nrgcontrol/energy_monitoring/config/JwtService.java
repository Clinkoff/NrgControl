...
public class JwtService {
    ...
    @Value("${jwt.secret:chaveSecretaDefault1234567890ChaveMuitoSegura}")
    private String secretKey;

    @Value("${jwt.expiration:86400000}") // 24 horas em milissegundos (default)
    ...
    // Gera um token sem claims extras
    ...
    // Obtém a chave para assinar o token
